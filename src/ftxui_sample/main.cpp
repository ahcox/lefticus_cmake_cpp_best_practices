...
// configuration step. It creates a namespace called `lefticus_cmake_cpp_best_practices`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", lefticus_cmake_cpp_best_practices::cmake::project_name, lefticus_cmake_cpp_best_practices::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", lefticus_cmake_cpp_best_practices::cmake::project_version);
      return EXIT_SUCCESS;
    }
